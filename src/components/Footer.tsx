...
export const Footer: FC = () => {
    ...
    return (
        <div className="">
            <footer
                className="text-center h-96 py-20 relative lg:text-left">
                <div className="overflow-hidden absolute right-0 bottom-0 flex items-stretch">
                    <svg width="1600" height="633" viewBox="0 0 1600 633" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <path opacity=".25" fillRule="evenodd" clipRule="evenodd"
                              ...
                              fill="url(#a)"/>
                        <defs>
                            <linearGradient id="a" x1="-378.062" y1="685.433" x2="125.035" y2="-766.8"
                ...
                <div className="mx-6 px-20 text-center absolute top-0 md:text-left">
                    <div className="grid lg:grid-cols-5 md:grid-cols-2 gap-4">
                        <div className="">
                            <h6 className="uppercase text-thistle font-montserrat font-bold mb-4 flex items-center justify-center md:justify-start">
                                ...
                                <p className="text-white text-base font-bold cursor-default font-quantico text-3xl ">
                                    GRANTS
                                </p>
                            </h6>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur consequuntur
                                dolorum error impedit ipsum porro qui ut. Animi beatae blanditiis earum iusto labore
                                neque non quibusdam quisquam, quod similique vero.
                            </p>
                        </div>
                        <div className="">
                            <h6 className="uppercase text-thistle font-montserrat font-bold mb-4 flex justify-center md:justify-start">
                                Community
                            </h6>
                            <p className="mb-4">
                                <a href="#" className="text-white">Donec dignissim</a>
                            </p>
                            <p className="mb-4">
                                <a href="#" className="text-white">Curabitur egestas</a>
                            </p>
                        </div>
                        <div className="">
                            <h6 className="uppercase text-thistle font-montserrat font-bold mb-4 flex justify-center md:justify-start">
                        ...
                        <div className="flex items-center -mx-20">
                            <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                                    className="text-white hover:bg-gray-600 border-magenta font-montserrat font-bold rounded-md text-md px-10 py-2.5 pl-2 inline-flex items-center border dark:hover:bg-gray-600 dark:focus:ring-blue-800"
                                    type="button" onClick={() => {
                                onClickDropdown()
                            }}>
                                ...
                                English - En
                                <svg className="w-4 h-4 ml-5" fill="none    "
                            ...
                            {showDropdown && <div id="dropdown"
                                                  className="z-10 bg-gray-600 divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700">
