...
export const Footer: FC = () => {
  ...
  return (
    <div className="">
      <footer className="text-center h-[190px] relative lg:text-left">
        ...
        <div className="mx-6 px-20 -my-6 text-center absolute top-0 md:text-left">
          <div className="grid lg:grid-cols-5 place-items-center md:grid-cols-2 gap-4">
            <div className="">
              <h6 className="uppercase text-thistle font-montserrat font-bold mb-4 flex items-center justify-center md:justify-start">
                ...
                <p className="text-white font-bold cursor-default font-quantico text-3xl ">
                  GRANTS
                </p>
              </h6>
              <p>
