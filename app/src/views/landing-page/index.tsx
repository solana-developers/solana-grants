                ...
                <div className='flex items-center w-[400px] h-[350px]'>
                    <div className='flex flex-col items-center m-8 md:items-start md:m-5'>
                        ...
                        <div className='flex justify-center mt-8'>
                            ...
                            <Link href='/explore'>
                                <button
                                    className='py-2 mr-4 text-sm text-black bg-green-400 rounded-full hover:bg-emerald-500 px-9'>
                                    EXPLORE
                                </button>
                            </Link>
                            <button
                                className="bg-transparent hover:bg-slate-500 py-2 px-6 text-fuchsia-300 border border-fuchsia-300 text-sm rounded-full btn"
                                onClick={navigateToCreateGrantPage}>
                                CREATE A GRANT
                            </button>
                        ...
                        {Array(5)
                            ...
                            .map((_, idx) => (
                                <div key={idx} className='carousel-item'>
                                    <div
                                        className='flex items-center justify-center h-56 m-4 slide-content w-52 bg-cyan-300 rounded-xl'>
